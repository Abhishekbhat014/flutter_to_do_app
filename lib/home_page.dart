                    ...
                    child: activeTask.isEmpty
                        ...
                        : ListView.builder(
                            ...
                            itemBuilder: (context, index) {
                              ...
                              return Card(
                                key: ValueKey("active-${task["key"]}-${task["isChecked"]}"),
                                  ...
                                  child: Row(
                                    ...
                                    children: [
                                      Checkbox(
                                        ...
                                        value: isChecked,
                                        onChanged: (value) {
                                          Map<String, dynamic> updatedTask = Map.from(task);
                                          updatedTask["isChecked"] = value;
                                          myBox.putAt(task["key"], updatedTask);
                                          loadTasks();
                                        },
                                      ),
                                      ...
                                      Column(
                                        ...
                                        children: [
                                          ...
                                          Text(
                                            task["priority"] ?? "",
                                            style: TextStyle(
                                              color: priority == "High" ? Colors.deepOrange : Colors.black,
                    ...
                    child: completedTask.isEmpty
                        ...
                        : ListView.builder(
                            ...
                            itemBuilder: (context, index) {
                              ...
                              return Card(
                                key: ValueKey("completed-${task["key"]}-${task["isChecked"]}"),
                                margin: EdgeInsets.symmetric(horizontal: 16, vertical: 8),
                                color: Constants.whiteColor,
                                child: AnimatedContainer(
                                  duration: Duration(milliseconds: 300),
